...
echo ""
echo "🌐 Access Points:"
echo "  • Medplum App (UI):    http://13.40.11.171:3000"
echo "  • Medplum Server:      http://13.40.11.171:8103"
echo "  • Health Check:        http://13.40.11.171:8103/healthcheck"
echo "  • FHIR API:            http://13.40.11.171:8103/fhir/R4/metadata"
echo ""
